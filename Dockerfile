...
RUN echo "cpu_tuple_cost = 0.00030" >> /etc/postgresql/$PGVER/main/postgresql.conf
RUN echo "cpu_index_tuple_cost = 0.00010" >> /etc/postgresql/$PGVER/main/postgresql.conf
RUN echo "cpu_operator_cost = 0.00005" >> /etc/postgresql/$PGVER/main/postgresql.conf
